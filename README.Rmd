...
| `mark_words`      | Highlight word stems                       |
...
Highlight sentences if they meet a contiditon (If multiple conditions are met the first condition that is met will be highlighted).  This essentially splits content into sentences and uses a `grepl` to determine if a condition is met.
